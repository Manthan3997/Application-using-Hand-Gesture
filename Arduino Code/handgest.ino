const int trigPin1 = 3; // the number of the trigger output pin ( sensor 1 )
const int echoPin1 = 4; // the number of the echo input pin ( sensor 1 )     
const int trigPin2 = 5;  // the number of the trigger output pin ( sensor 2 ) 
const int echoPin2 =6;  // the number of the echo input pin ( sensor 2 ) 
